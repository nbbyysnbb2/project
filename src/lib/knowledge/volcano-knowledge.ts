...
const KNOWLEDGE_CONFIG = {
  ...
  volcanoKnowledge: {
    ...
    apiKey: process.env.VOLCANO_API_KEY || 'c12e30bf-6ab7-42dc-85b2-d0686c966ffb',
    serviceResourceId: process.env.VOLCANO_SERVICE_RESOURCE_ID || 'kb-service-1cad042ac4cd788d',
  },
};
